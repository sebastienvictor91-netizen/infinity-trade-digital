...
export const Route = createFileRoute("/site-internet-artisan")({
  head: () => ({
    meta: [
      { title: "Site internet pour artisan dès 99€ — Infinity Trade & Digital" },
      { name: "description", content: "Un site web moderne et efficace pour artisans : devis, contact direct, photos de réalisations et présence locale." },
      { property: "og:title", content: "Site internet pour artisan premium" },
      { property: "og:description", content: "Un site web moderne et efficace pour artisans : devis, contact direct, photos de réalisations et présence locale." },
    ],
  }),
  component: () => (
    <MetierPage
      metier="artisan"
      title="Site internet pour artisan — moderne, rapide, efficace."
      intro="Un site web moderne et efficace pour artisans : devis, contact direct, photos de réalisations et présence locale."
      ...
      features={[
        { icon: Wrench, title: "Conçu pour artisan", description: "Un site pensé pour votre métier." },
